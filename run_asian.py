...
def run_baseline(args):
    ...
    print("\nRunning baseline (default parameters: breakout, 02:00 end, opposite stop, RR=2.0)...")
...
def main():
    parser = argparse.ArgumentParser(description="Asian Range Breakout / Fade Strategy")
